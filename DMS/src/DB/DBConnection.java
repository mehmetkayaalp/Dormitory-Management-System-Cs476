...
public class DBConnection {
	...
	public boolean insertStudent(Student st,EmergencyContact ec, School sc) throws SQLException{
		connect();
		try {
		    ...
		    proc_stmt.setString(5, ec.getSurname());  proc_stmt.setString(6, ec.getPhone());
		    proc_stmt.setString(7, st.getName());  proc_stmt.setString(8, st.getSurname());
		    proc_stmt.setString(9, st.getEmail());
		    proc_stmt.setString(10, st.getPhone());
		    proc_stmt.setString(11, st.getGender());  proc_stmt.setInt(13, st.getTC());
